...
//
// Вызов с фронтенда:  /.netlify/functions/tiingo?symbol=QQQ&start=1999-01-01
// Возвращает JSON-массив дневных баров Tiingo (date, close, high, low, open, adjClose, divCash, splitFactor).
